...
import com.back.khotwa.config.PropertiesConfig;
...
public class TJException {
    ...
    @Autowired
    public TJException(PropertiesConfig propertiesConfig) {
        TJException.propertiesConfig = propertiesConfig;
    }
    ...
    private static RuntimeException throwException(ExceptionType exceptionType, String messageTemplate, String... args) {
        ...
        }else if (ExceptionType.USER_NOT_ACTIVATED.equals(exceptionType))
            return new UserNotActivatedException(format(messageTemplate,args));
        return new RuntimeException(format(messageTemplate, args));
    }
